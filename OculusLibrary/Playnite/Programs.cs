...
namespace Playnite.Common
{
    ...
    public static class Programs
    {
        ...
        public static UninstallProgram GetOculusUninstallProgram()
        {
            return GetUninstallPrograms().FirstOrDefault(p => p.DisplayName == "Oculus");
        }

        public static UninstallProgram GetReviveUninstallProgram()
        {
            return GetUninstallPrograms().FirstOrDefault(p => p.DisplayName == "Revive Dashboard");
        }
    }
}
