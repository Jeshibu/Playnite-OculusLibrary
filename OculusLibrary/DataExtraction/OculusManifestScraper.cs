...
public class OculusManifestScraper(IOculusPathSniffer pathSniffer)
{
    ...
    private Dictionary<Guid, string> LibraryLocations => _libraryLocations ??= pathSniffer.GetOculusLibraryLocations();

    private string OculusInstallDir => _oculusInstallDir ??= pathSniffer.GetOculusSoftwareInstallationPath();
    ...
    private IEnumerable<ExpandedOculusManifest> GetManifests(bool installedOnly = false)
    {
