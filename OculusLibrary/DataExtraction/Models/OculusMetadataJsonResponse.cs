...
public class OculusJsonResponseDataNode
{
    ...
    public List<TagItem> SupportedInputDevicesList { get; set; } = [];
    ...
    public List<StarRatingAggregate> RatingAggregates { get; set; } = [];
    ...
    [JsonProperty("accolade_badges")]
    public List<AccoladeBadge> AccoladeBadges { get; set; }
}
...
public class AccoladeBadge
{
    [JsonProperty("translated_badge_name")]
    public string TranslatedBadgeName { get; set; }
